export const nightGlassSection =
  'rounded-3xl border border-white/[0.14] bg-black/50 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]'

export const dayGlassSection =
  'rounded-3xl border border-[color:var(--dawn-card-border)] bg-[color:var(--dawn-card)] shadow-[0_8px_40px_var(--dawn-shadow),inset_0_1px_0_rgba(255,255,255,0.65)]'

export const nightGlassHeroVoice =
  'rounded-3xl border border-white/[0.14] bg-gradient-to-br from-white/[0.07] via-black/48 to-black/85 text-parchment/95 shadow-[inset_0_1px_0_rgba(255,255,255,0.09),0_0_48px_rgba(0,0,0,0.5)] backdrop-blur-sm'

export const dayGlassHeroVoice =
  'rounded-3xl border border-[color:var(--dawn-card-border)] bg-[color:var(--dawn-card)] text-[color:var(--dawn-text)] shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_12px_48px_var(--dawn-shadow)] backdrop-blur-sm ring-1 ring-black/[0.05]'
...
export const dayMobileSectionShell =
  'relative overflow-hidden rounded-3xl border border-[color:var(--dawn-card-border)] bg-[color:var(--dawn-card)] p-5 shadow-[0_8px_40px_var(--dawn-shadow),inset_0_1px_0_rgba(255,255,255,0.65)] sm:p-6'
